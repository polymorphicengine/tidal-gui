...
bootTidal' = [ "p = streamReplace tidal"
              ...
              ,"d2 pat = p 2 $ pat |< orbit 2"
              ,"d3 pat = p 2 $ pat |< orbit 3"
              ,"d4 pat = p 3 $ pat |< orbit 4"
              ,"d5 pat = p 5 $ pat |< orbit 5"
              ,"d6 pat = p 6 $ pat |< orbit 6"
              ,"d7 pat = p 7 $ pat |< orbit 7"
              ,"d8 pat = p 8 $ pat |< orbit 8"
              ,"d9 pat = p 9 $ pat |< orbit 9"
